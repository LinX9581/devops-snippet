...
# 查看 sink 的 writer identity
gcloud logging sinks describe sink_swp_log

# 確認該 service account 有 Pub/Sub Publisher 權限
gcloud pubsub topics get-iam-policy swp_topic