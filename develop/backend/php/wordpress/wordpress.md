...
# 圖片搬到 GCS
1. 建立 bucket 並且要能對外且用 LB 綁定該 bucket 前台走 443 上傳自己的 cloudflare 憑證
2. subdomain 綁定 lb ip  
3. 安裝 wp-stateless 外掛 給有 gcs 權限的 key 並設定 domain 
以及GCS 物件快取規則 Cache-Control: public, max-age=31536000, immutable
