...
# 創建環境配置文件
sed -i "s/^ELASTIC_PASSWORD=.*/ELASTIC_PASSWORD=${elk_password}/" .env
sed -i "s/^LOGSTASH_INTERNAL_PASSWORD=.*/LOGSTASH_INTERNAL_PASSWORD=${elk_password}/" .env
sed -i "s/^KIBANA_SYSTEM_PASSWORD=.*/KIBANA_SYSTEM_PASSWORD=${elk_password}/" .env
